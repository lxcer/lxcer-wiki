...
## [2026-05-23] ingest | GitHub Hunter 每日推荐
...
- `raw/github-hunter/daily/2026-05-23.md`
- `index.md`
- `.github-hunter/state.json`

**今日项目**: thananon/9arm-skills, FoundZiGu/GuJumpgate, Doorman11991/smallcode, datawhalechina/Agent-Learning-Hub, Jawaz-Keyzor/FL-Studio-2026-Producer-Edition-Unlock
...
**更新文件**:
- `raw/github-hunter/index.md`
- `raw/github-hunter/daily/2026-05-22.md`
- `index.md`
- `.github-hunter/state.json`
...
**今日项目**: ultraworkers/claw-code, openclaw/openclaw, affaan-m/ECC, multica-ai/andrej-karpathy-skills, obra/superpowers
